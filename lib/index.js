...
exports["default"] = exports.GraphQLJSONObject = exports.GraphQLJSON = void 0;
...
function ensureObject(value) {
  if (typeof value === 'string') {
    try {
      ...
      throw new TypeError("The string '" + value + "' is not a valid parseable JSON string: " + e.message);
    }
  }
  ...
  parseLiteral: function parseLiteral(ast, variables) {
    if (ast.kind === _language.Kind.STRING) {
      try {
        ...
        throw new TypeError("The string '" + (0, _language.print)(ast) + "' is not a valid parseable JSON string: " + e.message);
      }
    }
